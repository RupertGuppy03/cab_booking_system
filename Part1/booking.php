...
/*
  ...
  Description: Server-side handler for the CabsOnline booking form. Receives POST data
               from booking.js, sanitises inputs, generates a unique booking reference
               number (BRN), booking datetime, and status, then inserts the full record
               into the MySQL bookings table. Returns an HTML confirmation message
               containing the booking reference number, pickup date, and pickup time.
...
/*
  ...
  Update DB_PASS to match your webdev account password.
*/
